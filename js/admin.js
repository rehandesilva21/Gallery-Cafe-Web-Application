...
function opencats() {
    ...
    document.getElementById("system-users").style.display = "none";
  }
  ...
  function openuser() {
    ...
    document.getElementById("events").style.display = "none";
    document.getElementById("reserv").style.display = "none";
    document.getElementById("system-users").style.display = "block";
...
function closenewmenu() {
    ...
    document.getElementById("addmenu1").style.display = "none";
  }
...
function delectacc(){
  document.getElementById("delete-acc-error").style.display="block";
}
function closemsg(){
  document.getElementById("delete-acc-error").style.display="none";
}
...
function closenewevent() {
  ...
  function addnewuser(){
    document.getElementById("add-user-1").style.display = "block";
    document.getElementById("add-user").style.display = "block";

  }
  function closenewuser(){
    document.getElementById("add-user-1").style.display = "none";
